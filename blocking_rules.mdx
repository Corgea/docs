...
- For **Dependency Vulnerability rules**, begin with Critical severity only, then add High as your team adjusts
...
- Consider creating separate rules for different project types or teams
</Card>
