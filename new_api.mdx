...
Example Usage:
```bash
curl https://api.example.com/verify/your_token_here
```
...
Example Usage:
```bash
curl -X POST https://api.example.com/scan-upload?run_id=123&engine=corgea&project=myproject \
...
Example Usage:
```bash
curl https://api.example.com/scans?project=myproject&page=1&page_size=10 \
  -H "CORGEA-TOKEN: Bearer your_api_key"
```
...
Example Usage:
```bash
curl https://api.example.com/scan/scan_id_here \
  -H "CORGEA-TOKEN: Bearer your_api_key"
```
...
Example Usage:
```bash
curl https://api.example.com/scan/scan_id_here/issues?page=1&page_size=10 \
  -H "CORGEA-TOKEN: Bearer your_api_key"
```
...
Example Usage:
```bash
curl https://api.example.com/issue/issue_id_here?show_full_code=true \
  -H "CORGEA-TOKEN: Bearer your_api_key"
```
