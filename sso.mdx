...
- lastName (user.profile.lastName)
  ...
  <Card>
    <img src="/images/okta_sso_groups_attributes.png" style={{ borderRadius: '0.5rem' }} alt="Okta Config" />
  </Card>
...
3. If the domain needs to move to a different workspace, contact Corgea support (support@corgea.com) so we can help verify the correct ownership and update the configuration safely.
...
The SCIM token can be found in the SSO Configuration modal:
  ...
  <Card>
    <img src="/images/scim_token_sso_modal.png" style={{ borderRadius: '0.5rem' }} alt="SCIM Token in SSO Modal" />
  </Card>
