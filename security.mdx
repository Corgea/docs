...
<AccordionGroup>
  ...
  <Accordion icon="users" title="Which 3rd parties do you share data with?">
    ...
    - OpenAI or AzureOpenAI: used in aiding Corgea in fixing insecure code, and in part of the fix QA process. We maintain a ZDR (Zero Data Retention) with both. 
    ...
    - PostHog: product analytics and client error tracking.
  </Accordion>
