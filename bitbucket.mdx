...
<Note>
If a CI scan cannot start within a short timeout window, Corgea automatically cancels it and the Bitbucket check is marked as **Stopped**. Re-run the pipeline or push a new commit to trigger a fresh scan.
</Note>
