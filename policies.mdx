...
6. **Guidance Notes (Optional)**: Add static guidance for developers, such as internal remediation notes, links to internal standards, or implementation tips. This guidance is shown when viewing issues that were affected by the policy.

7. **Instruction Type**: Choose how your policy instructions interact with Corgea's built-in policies:
