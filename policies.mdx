...
You can now use Policy Playground for both creating and updating policies.
...
### Corgea-managed policies

Some generated or admin-managed policies may be marked as Corgea-managed and read-only.

- For non-superusers, these policies cannot be edited or deleted.
- For **BLAST** and **False Positive** policies, you can still open them in **Policy Playground** to review behavior.
...
<Steps>
  <Step title="Click Generate Policy">
    ...
    <Frame>
      <img src="/images/prework/policy_generate_policy_button.png" style={{ borderRadius: '0.5rem' }} />
    </Frame>
  </Step>
  <Step title="Fill Out the Generation Form">
    ...
    <Frame>
      <img src="/images/prework/poilcy_generate_policy_form.png" style={{ borderRadius: '0.5rem' }} />
    </Frame>
  </Step>
  <Step title="Wait for Prework to Complete">
    ...
    <Frame>
      <img src="/images/prework/policy_generation_in_progress.png" style={{ borderRadius: '0.5rem' }} />
    </Frame>
  </Step>
  <Step title="Review the Generated Policy">
    ...
    <Frame>
      <img src="/images/prework/policy_generated_policy.png" style={{ borderRadius: '0.5rem' }} />
    </Frame>
  </Step>
</Steps>
