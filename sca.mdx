...
In scan results, package groups include badges that show where vulnerable dependencies appear:
- **Direct**: The vulnerable package is a direct dependency in your manifest.
- **Transitive**: The vulnerable package is pulled in through another dependency.

On the SCA issue details page, a **Sub-dependencies** badge is shown when the selected package has nested dependencies.
