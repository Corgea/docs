...
<img src="/images/dependencies/dependencies_view.png" alt="Dependencies View" />
...
### Project Dependencies in Scan Details

From a scan's SCA findings section, use **Project Dependencies** to open a full dependency inventory for that scan.

- **List View**: Browse dependencies with pagination and search by name, version, or package URL
- **Tree View**: Inspect direct and transitive dependency relationships in hierarchy form
- **Dependency Type Filter**: Switch between all, direct, and transitive dependencies
- **Download SBOM**: Export the scan's SBOM as a JSON file for external review or archiving

<Info>This view is available for dependency scans and is not shown for Dockerfile-only container scan results.</Info>
