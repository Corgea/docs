...
Once your project is added, you have two options for uploading a security report:

- **Option 1**: If you have [**BLAST**](blast) enabled—Corgea’s AI-powered security scanner—you can initiate a scan directly within Corgea.
<Frame>
...
- **Option 2**: If you are using another security tool, you can upload a scan report from that tool. Just select the report file (typically a JSON file) from your local machine and drop it into the upload box.
