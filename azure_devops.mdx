...
<Note>
If a CI scan cannot start within a short timeout window, Corgea automatically cancels it and the Azure DevOps check status is set to **Not applicable**. Re-run the pipeline or push a new commit to trigger a fresh scan.
</Note>
