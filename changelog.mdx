...
<Update label="2026.03.19" description="v1.61.2">
  **New Features:**
  ...
  **Reliability & Stability:**
  - Restored backward compatibility for scan code ZIP retrieval so existing API consumers continue to work while streaming ZIP delivery remains supported. — [Learn more](/upload-report)
  - Added scheduled cleanup for abandoned temporary upload files to reduce failures caused by stale upload artifacts. — [Learn more](/upload-report)
  - Added scan pickup timestamps to improve scan duration accuracy and processing visibility.
  - Improved backward compatibility for profile usage fields to make upgrades from older versions smoother.
  - Improved logging behavior and plan-limit handling so integrations return clearer non-failure outcomes when usage limits are reached.
</Update>

<Update label="2026.03.19" description="v1.61.1">
  **New Features:**
  ...
  **Reliability & Stability:**
  - Improved large-repository scan handling and source ZIP streaming to reduce missed scans and improve stability for larger code archives. — [Learn more](/upload-report)
  ...
  - Ordered unprocessed scans by creation time for more predictable scan processing behavior.
  - Added a backward-compatible stream option for internal scan code ZIP retrieval.
</Update>

<Update label="2026.03.17" description="v1.61.0">
  **New Features:**
