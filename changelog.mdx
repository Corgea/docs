...
<Update label="2026.03.27" description="v1.61.3">
  ...
  **Reliability & Stability:**
  ...
  - Improved scan metadata handling by accepting broader metadata keys and storing canary metadata separately for cleaner scan telemetry.
  - Improved integration resilience with tighter timeout handling and streamed ZIP downloads across Git and ticketing workflows.
</Update>
