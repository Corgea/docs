...
<Update label="2026.02.27" description="v1.60.2">
  **Security & Permissions:**
  - API access is now validated against your current plan, and requests return a clear access-denied response when API access is not included — [Learn more](/api-reference/introduction)

  **Reliability & Stability:**
  - Maintenance release with internal testing and automation improvements
</Update>
