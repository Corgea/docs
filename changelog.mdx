...
<Update label="2026.02.27" description="v1.60.2">
  **New Features:**
  - Added support for Coverity report uploads to expand third-party scanner compatibility. — [Learn more](/upload-report)
  - Introduced self-service billing with seat-based plan controls for easier subscription management. — [Learn more](/user_management)
  - Feedback History now stores and displays agent replies alongside user comments for better auditability. — [Learn more](/agent)

  **UI & Experience:**
  - Improved Teams navigation so clicking a team's project count opens the assigned projects list directly. — [Learn more](/teams)

  **Reliability & Stability:**
  - Improved dependency project filtering and PR comment handling reliability with expanded test coverage. — [Learn more](/sca)
  - Reduced non-actionable PR diff overlap error noise to improve platform stability.
