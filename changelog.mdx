...
<Update label="2026.01.14" description="v1.57.3">
  **New Features:**
  - Added filter view for better project organization and navigation.
  - Added ability to assign teams to projects and vice versa for improved collaboration.
  - Added excluded button option for scanning to give you more control over what gets scanned.

  **UI & Experience:**
  - Improved project name and repository URL handling to be case-insensitive for easier setup.
  - Enhanced user creation flow with better error handling.

  **Reliability & Stability:**
  - Improved error handling for GitLab integration workflows.
  - Enhanced logging for Bitbucket authentication to help diagnose connection issues.
  - General bug fixes and improvements for a more stable experience.
</Update>
