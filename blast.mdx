...
In addition to business logic vulnerabilities, AI-native SAST can also detect common security flaws found in regular SAST scanning.

## Secret Scanning Capabilities

AI-native SAST's secret scanner uses pattern matching, entropy analysis, and AI-powered contextual understanding to minimize false positives while ensuring comprehensive coverage.
...
<Tip>When secrets are detected, AI-native SAST provides detailed information about the type, location, security impact, and secure storage alternatives.</Tip>
