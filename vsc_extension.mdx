...
<Note>We will be hosting the Visual Studio Code extension on the extension market place soon.</Note>

1. [Download](https://github.com/Corgea/vs_code_plugin/releases/download/v1.0.2/corgea-1.0.2.vsix) the extension.
