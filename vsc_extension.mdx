...
2. Access the Extensions marketplace by clicking on the Extensions icon in the sidebar or pressing `Ctrl+Shift+X`.
3. Search for "Corgea" in the marketplace search bar.
4. Click the `Install` button on the Corgea extension tile.
