...
Click **Edit** on any schedule to modify its name, scope, scan types, or frequency. Corgea recalculates the **Next Run** timestamp immediately after you save, and the updated configuration is used for the next scheduled run.
