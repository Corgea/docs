...
<Info>
  **Prerequisite** You have a connected repository (GitHub, GitLab, Azure DevOps, or Bitbucket) and Scheduled Scans enabled on your plan. Reach out to your Corgea contact to enable this feature.
</Info>
...
<Steps>
  ...
  <Step title="Set the frequency">
    ...
    <Info>
      Daily scheduling may require a higher plan tier. Contact your Corgea account team for details.
    </Info>
  </Step>
